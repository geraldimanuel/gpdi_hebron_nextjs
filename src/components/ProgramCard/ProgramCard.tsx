...
export function ProgramCard({
  ...
  children,
    ...
    return (
        ...
        >
            <div className="relative grid grid-rows-2 md:grid-rows-1 md:grid-cols-2 w-full gap-8 z-10">
              <div className="drop-shadow-[6px_6px_0px_rgba(210,2,2,1)] object-contain">
